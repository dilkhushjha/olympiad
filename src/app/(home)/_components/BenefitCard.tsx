...
export default function BenefitCardSection() {
    return (
        ...
        <div className="flex  sm:flex-row sm:flex-nowrap gap-6 bg-[#F6F9FE] px-4 sm:px-6  lg:px-8 py-8">
            {benefits.map((item, index) => (
                <div
                    key={index}
                    className="rounded-3xl shadow-sm p-6 flex flex-col  w-[250px] items-start  h-[300px] bg-cover bg-center"
