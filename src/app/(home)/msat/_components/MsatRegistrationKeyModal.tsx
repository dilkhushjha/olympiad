...
const MsatRegistrationKeyModal = ({ onClose }) => {
            ...
            <div className="fixed inset-0 bg-gray-900 bg-opacity-50  flex justify-center items-center z-50">
                <div className="bg-white w-max rounded-3xl shadow-lg z-999 ">
                    <div className=" py-10 px-14 flex flex-col items-center justify-center rounded-2xl text-center gap-6 relative bg-white">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4 flex flex-col text-black">


                            <div className="flex flex-col gap-10">

                                <h2 className="text-2xl font-semibold text-black">Please Enter your <br />
                                    M-SAT Registration No.
                                </h2>
                                <div className="flex flex-col gap-2">
                                    <p className="text-sm text-left text-Grey-Shade_1">Matrix - SAT Registration No.</p>
                                    <input type="text" name="registraionNo" id="" placeholder='E.g, 2275' className='border p-4 rounded-lg form-control' required />
                                </div>
                            ...
                            <div className='pt-4 m-auto'>
                                ...
                                >
                                    Next <svg width="17" height="18" viewBox="0 0 17 18" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export default MsatRegistrationKeyModal