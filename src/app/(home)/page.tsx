...
const Olympiad = () => {
    return (
        <>
            {/* Hero Section */}
            <section className="w-screen bg-[url('/images/olympiad/Hero.png')] bg-center bg-cover pt-[120px] sm:pt-[120px] lg:pt-[140px]">
                <div className="container mx-auto sm:px">
                    <div className="flex flex-col lg:flex-row gap-6 lg:gap-12">
                        ...
                        <div className="flex flex-col gap-6 lg:w-2/3">
                            <div className="text-center lg:text-left">
                                ...
                                <h1 className="text-2xl sm:text-4xl lg:text-[44px] font-bold text-white leading-[1.25] mt-3">
                    ...
                    <div className="flex flex-col gap-10">
                        ...
                        <div className="flex flex-col xl:flex-row x gap-10 mx-auto text-center">
                            ...
                            <div className="rounded-2xl text-center p-6  bg-[url('/images/olympiad/about-card-bg.png')] bg-cover bg-center w-[350px]">
                                <div className="flex flex-col gap-6">
                                    <Image
                                        src={"/images/olympiad/checklist.png"}
                                        alt="about"
                                        height={120}
                                        width={130}
                                        className="mx-auto h-[120px]"
