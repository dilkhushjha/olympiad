                ...
                <div className="container mx-auto">
                    ...
                    <div className=" flex flex-col xl:gap-[80px]">
                        <div className="flex flex-col gap-3 text-center">
                            ...
                            <p className="text-xl text-Secondary-Shade_2 font-semibold">Exam Dates & Phases</p>
                            <h2 className="text-2xl xl:text-3xl md:text-2xl font-bold">Important Dates & Exam Phases</h2>
                        </div>


                        <div className="flex gap-10 mx-auto text-center">
                            <div className="rounded-2xl text-center p-6   bg-cover bg-center border-2 w-[350px]">
                                <p className="text-left px-11 py-2 bg-Secondary-Shade_2 text-white w-max rounded-xl font-bold text-xl my-[-60px] absolute">Phase 1</p>


                                <div className="flex flex-col gap-10">
                                    <div className="flex gap-3 items-center mt-2">
                                        <Image src={'/images/olympiad/calender.png'} alt='about' height={60} width={60} className=''></Image>

                                        <p className="text-2xl  font-bold ">5 Oct, 2025</p>
                                    </div>
                                    <p className="text-[20px] font-medium text-left text-Grey-Shade_1">Madhya Pradesh (MP), Bihar, <br /> Uttar Pradesh (UP),<br /> Rajasthan - Sikar</p>
                                </div>

                            </div>
                            <div className="rounded-2xl text-center p-6   bg-cover bg-center border-2 w-[350px]">
                                <p className="text-left px-11 py-2 bg-Secondary-Shade_2 text-white w-max rounded-xl font-bold text-xl my-[-60px] absolute">Phase 2</p>
                                ...
                                <div className="flex flex-col gap-10">
                                    ...
                                    <p className="text-[20px] font-medium text-left text-Grey-Shade_1">Rajasthan - Sikar , Leh, <br /> Jammu</p>
                                </div>
                            ...
                            <div className="rounded-2xl text-center p-6   bg-cover bg-center border-2 w-[350px]">
                                ...
                                <div className="flex flex-col gap-10">
                                    ...
                                    <p className="text-[20px] font-medium text-left text-Grey-Shade_1">Haryana, Manipur, Online</p>
                                </div>
